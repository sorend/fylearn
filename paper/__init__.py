...
learners = (
    ...
    (r"$\text{FPC}_{\text{pa}}$", fpcga.FuzzyPatternClassifierGA(mu_factories=(fpcga.build_pi_membership,), aggregation_rules=(fl.prod, np.min, fl.mean, np.max, fl.algebraic_sum), iterations=100, epsilon=None)),
    (r"$\text{SFPC}_{\text{pp}}$", fpcga.FuzzyPatternClassifierGA2(mu_factories=(fpcga.build_pi_membership,), aggregation_rules=(fl.prod,), iterations=25, epsilon=None)),
