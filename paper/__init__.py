...
learners = (
    ...
    (r"$\text{FPC}_{\text{tp}}$", fpcga.FuzzyPatternClassifierGA(mu_factories=(fpcga.build_pi_membership,), aggregation_rules=(fl.prod, np.min, fl.mean, np.max, fl.algebraic_sum), iterations=100, epsilon=None)),
